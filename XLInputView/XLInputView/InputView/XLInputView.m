...
- (void)setXl_textHeightChangeBlock:(void (^)(NSString * _Nonnull, CGFloat))xl_textHeightChangeBlock
{
    _xl_textHeightChangeBlock = xl_textHeightChangeBlock;
...
- (void)textDidChange{
    ...
    if (_textH != height) { // 高度不一样，就改变了高度
        ...
        if (_xl_textHeightChangeBlock && self.scrollEnabled == NO) {
            _xl_textHeightChangeBlock(self.text,height);
